      ...
      <header className={styles.header}>
        ...
        <div className={styles.hero}>
          ...
          <p className={styles.hero_desc}>
            I have over three years of extensive experience with building
            creative products from scratch
          </p>
          <ul className={styles.hero_highlights}>
            <li>
              I create delightful apps while understanding industry UI/UX best
              practices
            </li>
            ...
            <div className={styles.fields}>
              ...
              >
                <div className={styles.field_info}>
                  ...
                  <p className={styles.field_text}>
                    Probably I'm not the best UI/UX designer you'll ever see,
                    but I Do design. And I make my works with rich user
                    experiences while staying fashionable
                  </p>
                </div>
                <div
                  className={`${styles.field_decoration} ${styles.design}`}
                />
              </motion.div>
              <motion.div
                initial={{ opacity: 0, x: 200 }}
              ...
              >
                ...
                <div className={styles.field_info}>
                  ...
                  <p className={styles.field_text}>
                    I build javascript applications with right tools and
                    libraries, and can deliver fast, resilent solutions
                    optimized for scale - performance and scalability are my
                    priorities
                  </p>
                </div>
              </motion.div>
              ...
              >
                <div className={styles.field_info}>
                  ...
                  <p className={styles.field_text}>
                    Haven't created any commercial mobile app yet, but I've
                    built some for my own purposes such as automation of my life
                    routine
                  </p>
                </div>
                <div
                  className={`${styles.field_decoration} ${styles.mobile}`}
                />
              </motion.div>
            </div>
          </div>
